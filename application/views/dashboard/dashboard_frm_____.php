...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
       <img style="height: 629px;width:355px;position: relative;bottom: -66px;left: -66px"  src="<?=base_url("")?>/dist/img/phone_random.png">
    ...
    <div class="col-sm-8">
        <label​ style="bottom:555px;left:2px;font-size:28px;color:red;position:absolute;font-family:'Khmer OS Muol'">រីករាយជាមួយនឹងការផ្សងសំណាង!</label>
        ...
        <img style="width: 220px;position: absolute;bottom: -586px;left:-34px"  src="<?=base_url("")?>/dist/img/win1.png">
        <img style="width:270px;position: absolute;bottom: -607px;left:167px"  src="<?=base_url("")?>/dist/img/A1.png">
        <img style="width:330px;position: absolute;bottom: -583px;left:305px"  src="<?=base_url("")?>/dist/img/A2.png">
        <img style="width:210px;position: absolute;bottom: -576px;left:528px"  src="<?=base_url("")?>/dist/img/A3.png">
    </div>
  </div>
  <div class="row">
      <div class="col-sm-12">
        <label​ style="bottom:210px;left:550px;font-size:18px;color:black;position:absolute;font-family:'Khmer OS Battambang'">ឈ្នះរង្វាន់ទូរសព្ទដៃ នឹងម៉ូតូ ១​ គ្រឿង</label>
     </div>
  </div>
</div>
